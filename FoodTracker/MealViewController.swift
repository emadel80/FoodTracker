                      ...
                      UINavigationControllerDelegate
{
  ...
  // in `prepare(for:sender:)` or constructed as part of 
  // adding a new meal
  var meal: Meal?
  ...
  override func viewDidLoad() {
    ...
    // Enable the Save button only if the text field has a valid
    // Meal name
  ...
  override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
    ...
    // Configure the destination view controller only when the save
    // button is pressed
